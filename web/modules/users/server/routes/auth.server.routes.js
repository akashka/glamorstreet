...
module.exports = function (app) {
  ...
  app.route('/api/forgotPassword').get(users.forgotPassword);
  ...
  //facebook and google token based login routes
  app.route('/api/getFbLoginDetails').get(users.getFacebookSigninData);
  app.route('/api/getGoogleLoginDetails').get(users.getgoogleSigninData);
  app.route('/api/socialSignin').get(users.socialSignin);
