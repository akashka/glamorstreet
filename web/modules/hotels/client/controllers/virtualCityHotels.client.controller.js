(function() {
  ...
  $http, $filter, $uibModal, $timeout, Calculate, $location, CLIENT) {
    ...
    $scope.markers = [];
     ...
     $scope.checkin = (moment('2017-09-02').add(1, 'day').format('MM-DD-YYYY'));
    $scope.checkout = (moment('2017-09-02').add(2, 'day').format('MM-DD-YYYY'));

    //$scope.checkin = '09-03-2017';
    //$scope.checkout = '09-03-2017';
    $scope.dataReceived = false;
    $scope.markers = [];
 }
    ...
    HotelsServices.getBreak($scope.params).success(function(res) {
      if (res) {
